...
job_option_single_particle_txt_dependencies = ../share/job_option_single_particle.txt
test_txt_dependencies = ../share/test.txt
log_txt_dependencies = ../share/log.txt


install_runtimeinstall :: ${install_dir}/job_option_single_particle.txt
	@if test ! "${installarea}" = ""; then\
	  echo "installation done"; \
	fi

${install_dir}/job_option_single_particle.txt :: ../share/job_option_single_particle.txt
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../share/job_option_single_particle.txt`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "job_option_single_particle.txt" "$(install_dir)" "cp -R" ; \
	fi
...
install_runtimeuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "job_option_single_particle.txt" "$(install_dir)" "cp -R" ; \
	fi
