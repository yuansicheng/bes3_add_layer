...
#cmt_local_tagfile = $(KalFitAlg_tag).make
cmt_local_tagfile = $(bin)$(KalFitAlg_tag).make
...
cmt_local_setup_KalFitAlg = $(bin)setup_KalFitAlg$$$$.make
...
KalFitAlg_extratags = -tag_add=target_KalFitAlg

#$(cmt_local_tagfile_KalFitAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_KalFitAlg) ::
else
$(cmt_local_tagfile_KalFitAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_KalFitAlg); then /bin/rm -f $(cmt_local_tagfile_KalFitAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(KalFitAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_KalFitAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_KalFitAlg)"; \
	  test ! -f $(cmt_local_setup_KalFitAlg) || \rm -f $(cmt_local_setup_KalFitAlg); \
	  trap '\rm -f $(cmt_local_setup_KalFitAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(KalFitAlg_extratags) show setup >$(cmt_local_setup_KalFitAlg) && \
	  if [ -f $(cmt_final_setup_KalFitAlg) ] && \
	    \cmp -s $(cmt_final_setup_KalFitAlg) $(cmt_local_setup_KalFitAlg); then \
	    \rm $(cmt_local_setup_KalFitAlg); else \
	    \mv -f $(cmt_local_setup_KalFitAlg) $(cmt_final_setup_KalFitAlg); fi
...
not_KalFitAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(KalFitAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
KalFitAlgdirs :
	@if test ! -d $(bin)KalFitAlg; then $(mkdir) -p $(bin)KalFitAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)KalFitAlg
else
KalFitAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)KalFitAlg
#
#$(cmt_local_KalFitAlg_makefile) :: $(KalFitAlg_dependencies) $(cmt_local_tagfile_KalFitAlg) build_library_links dirs KalFitAlgdirs
#else
#$(cmt_local_KalFitAlg_makefile) :: $(KalFitAlg_dependencies) $(cmt_local_tagfile_KalFitAlg) build_library_links dirs
#endif
#else
#$(cmt_local_KalFitAlg_makefile) :: $(cmt_local_tagfile_KalFitAlg)
#endif

ifdef cmt_KalFitAlg_has_target_tag

ifndef QUICK
$(cmt_local_KalFitAlg_makefile) : $(KalFitAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building KalFitAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(KalFitAlg_extratags) build constituent_config -out=$(cmt_local_KalFitAlg_makefile) KalFitAlg
else
$(cmt_local_KalFitAlg_makefile) : $(KalFitAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_KalFitAlg) ] || \
	  [ ! -f $(cmt_final_setup_KalFitAlg) ] || \
	  $(not_KalFitAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building KalFitAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(KalFitAlg_extratags) build constituent_config -out=$(cmt_local_KalFitAlg_makefile) KalFitAlg; \
	  fi
endif
...
$(cmt_local_KalFitAlg_makefile) : $(KalFitAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building KalFitAlg.make"; \
	  $(cmtexe) -f=$(bin)KalFitAlg.in -tag=$(tags) $(KalFitAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_KalFitAlg_makefile) KalFitAlg
else
$(cmt_local_KalFitAlg_makefile) : $(KalFitAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)KalFitAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_KalFitAlg) ] || \
	  [ ! -f $(cmt_final_setup_KalFitAlg) ] || \
	  $(not_KalFitAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(KalFitAlg_extratags) build constituent_makefile -out=$(cmt_local_KalFitAlg_makefile) KalFitAlg

KalFitAlg :: $(KalFitAlg_dependencies) $(cmt_local_KalFitAlg_makefile) dirs KalFitAlgdirs
	$(echo) "(constituents.make) Starting KalFitAlg"
	@if test -f $(cmt_local_KalFitAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_KalFitAlg_makefile) KalFitAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_KalFitAlg_makefile) KalFitAlg
	$(echo) "(constituents.make) KalFitAlg done"

clean :: KalFitAlgclean

KalFitAlgclean :: $(KalFitAlgclean_dependencies) ##$(cmt_local_KalFitAlg_makefile)
	$(echo) "(constituents.make) Starting KalFitAlgclean"
	@-if test -f $(cmt_local_KalFitAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_KalFitAlg_makefile) KalFitAlgclean; \
	fi
	$(echo) "(constituents.make) KalFitAlgclean done"
#	@-$(MAKE) -f $(cmt_local_KalFitAlg_makefile) KalFitAlgclean

##	  /bin/rm -f $(cmt_local_KalFitAlg_makefile) $(bin)KalFitAlg_dependencies.make

install :: KalFitAlginstall

KalFitAlginstall :: $(KalFitAlg_dependencies) $(cmt_local_KalFitAlg_makefile)
	$(echo) "(constituents.make) Starting install KalFitAlg"
	@-$(MAKE) -f $(cmt_local_KalFitAlg_makefile) install
	$(echo) "(constituents.make) install KalFitAlg done"

uninstall : KalFitAlguninstall

$(foreach d,$(KalFitAlg_dependencies),$(eval $(d)uninstall_dependencies += KalFitAlguninstall))

KalFitAlguninstall : $(KalFitAlguninstall_dependencies) ##$(cmt_local_KalFitAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall KalFitAlg"
	@if test -f $(cmt_local_KalFitAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_KalFitAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_KalFitAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall KalFitAlg done"

remove_library_links :: KalFitAlguninstall
...
#cmt_local_tagfile_config = $(KalFitAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(KalFitAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)KalFitAlg_configsetup.make
...
#cmt_local_tagfile_config = $(KalFitAlg_tag).make
cmt_local_tagfile_config = $(bin)$(KalFitAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)KalFitAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(KalFitAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(KalFitAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)KalFitAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(KalFitAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(KalFitAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)KalFitAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(KalFitAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(KalFitAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)KalFitAlg_makesetup.make
...
#cmt_local_tagfile_make = $(KalFitAlg_tag).make
cmt_local_tagfile_make = $(bin)$(KalFitAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)KalFitAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(KalFitAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(KalFitAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)KalFitAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(KalFitAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(KalFitAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)KalFitAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(KalFitAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(KalFitAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)KalFitAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(KalFitAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(KalFitAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)KalFitAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(KalFitAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(KalFitAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)KalFitAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(KalFitAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(KalFitAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)KalFitAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(KalFitAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(KalFitAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)KalFitAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(KalFitAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(KalFitAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)KalFitAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(KalFitAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(KalFitAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)KalFitAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(KalFitAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(KalFitAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)KalFitAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(KalFitAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(KalFitAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)KalFitAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(KalFitAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(KalFitAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)KalFitAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(KalFitAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(KalFitAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)KalFitAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(KalFitAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(KalFitAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)KalFitAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
