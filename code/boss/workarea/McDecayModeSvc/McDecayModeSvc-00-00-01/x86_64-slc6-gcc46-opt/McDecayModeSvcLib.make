...
#
#   Generated Sun Jan 22 16:58:13 2023  by yuansc
#
#====================================
...
$(McDecayModeSvcLiblib) :: $(bin)DecayParticle.o $(bin)DecayModes.o $(bin)McDecayModeSvc.o $(bin)PartId2Name.o
	$(lib_echo) library
	$(lib_silent) cd $(bin); \
...
McDecayModeSvcLibclean ::
	...
	$(cleanup_silent) cd $(bin); /bin/rm -f $(bin)DecayParticle.o $(bin)DecayModes.o $(bin)McDecayModeSvc.o $(bin)PartId2Name.o
