...
#cmt_local_tagfile = $(VertexFit_tag).make
cmt_local_tagfile = $(bin)$(VertexFit_tag).make
...
cmt_local_setup_VertexFit = $(bin)setup_VertexFit$$$$.make
...
VertexFit_extratags = -tag_add=target_VertexFit

#$(cmt_local_tagfile_VertexFit) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_VertexFit) ::
else
$(cmt_local_tagfile_VertexFit) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_VertexFit); then /bin/rm -f $(cmt_local_tagfile_VertexFit); fi ; \
	  $(cmtexe) -tag=$(tags) $(VertexFit_extratags) build tag_makefile >>$(cmt_local_tagfile_VertexFit)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_VertexFit)"; \
	  test ! -f $(cmt_local_setup_VertexFit) || \rm -f $(cmt_local_setup_VertexFit); \
	  trap '\rm -f $(cmt_local_setup_VertexFit)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(VertexFit_extratags) show setup >$(cmt_local_setup_VertexFit) && \
	  if [ -f $(cmt_final_setup_VertexFit) ] && \
	    \cmp -s $(cmt_final_setup_VertexFit) $(cmt_local_setup_VertexFit); then \
	    \rm $(cmt_local_setup_VertexFit); else \
	    \mv -f $(cmt_local_setup_VertexFit) $(cmt_final_setup_VertexFit); fi
...
not_VertexFit_dependencies = { n=0; for p in $?; do m=0; for d in $(VertexFit_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
VertexFitdirs :
	@if test ! -d $(bin)VertexFit; then $(mkdir) -p $(bin)VertexFit; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)VertexFit
else
VertexFitdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)VertexFit
#
#$(cmt_local_VertexFit_makefile) :: $(VertexFit_dependencies) $(cmt_local_tagfile_VertexFit) build_library_links dirs VertexFitdirs
#else
#$(cmt_local_VertexFit_makefile) :: $(VertexFit_dependencies) $(cmt_local_tagfile_VertexFit) build_library_links dirs
#endif
#else
#$(cmt_local_VertexFit_makefile) :: $(cmt_local_tagfile_VertexFit)
#endif

ifdef cmt_VertexFit_has_target_tag

ifndef QUICK
$(cmt_local_VertexFit_makefile) : $(VertexFit_dependencies) build_library_links
	$(echo) "(constituents.make) Building VertexFit.make"; \
	  $(cmtexe) -tag=$(tags) $(VertexFit_extratags) build constituent_config -out=$(cmt_local_VertexFit_makefile) VertexFit
else
$(cmt_local_VertexFit_makefile) : $(VertexFit_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_VertexFit) ] || \
	  [ ! -f $(cmt_final_setup_VertexFit) ] || \
	  $(not_VertexFit_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building VertexFit.make"; \
	  $(cmtexe) -tag=$(tags) $(VertexFit_extratags) build constituent_config -out=$(cmt_local_VertexFit_makefile) VertexFit; \
	  fi
endif
...
$(cmt_local_VertexFit_makefile) : $(VertexFit_dependencies) build_library_links
	$(echo) "(constituents.make) Building VertexFit.make"; \
	  $(cmtexe) -f=$(bin)VertexFit.in -tag=$(tags) $(VertexFit_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_VertexFit_makefile) VertexFit
else
$(cmt_local_VertexFit_makefile) : $(VertexFit_dependencies) $(cmt_build_library_linksstamp) $(bin)VertexFit.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_VertexFit) ] || \
	  [ ! -f $(cmt_final_setup_VertexFit) ] || \
	  $(not_VertexFit_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(VertexFit_extratags) build constituent_makefile -out=$(cmt_local_VertexFit_makefile) VertexFit

VertexFit :: $(VertexFit_dependencies) $(cmt_local_VertexFit_makefile) dirs VertexFitdirs
	$(echo) "(constituents.make) Starting VertexFit"
	@if test -f $(cmt_local_VertexFit_makefile); then \
	  $(MAKE) -f $(cmt_local_VertexFit_makefile) VertexFit; \
	  fi
#	@$(MAKE) -f $(cmt_local_VertexFit_makefile) VertexFit
	$(echo) "(constituents.make) VertexFit done"

clean :: VertexFitclean

VertexFitclean :: $(VertexFitclean_dependencies) ##$(cmt_local_VertexFit_makefile)
	$(echo) "(constituents.make) Starting VertexFitclean"
	@-if test -f $(cmt_local_VertexFit_makefile); then \
	  $(MAKE) -f $(cmt_local_VertexFit_makefile) VertexFitclean; \
	fi
	$(echo) "(constituents.make) VertexFitclean done"
#	@-$(MAKE) -f $(cmt_local_VertexFit_makefile) VertexFitclean

##	  /bin/rm -f $(cmt_local_VertexFit_makefile) $(bin)VertexFit_dependencies.make

install :: VertexFitinstall

VertexFitinstall :: $(VertexFit_dependencies) $(cmt_local_VertexFit_makefile)
	$(echo) "(constituents.make) Starting install VertexFit"
	@-$(MAKE) -f $(cmt_local_VertexFit_makefile) install
	$(echo) "(constituents.make) install VertexFit done"

uninstall : VertexFituninstall

$(foreach d,$(VertexFit_dependencies),$(eval $(d)uninstall_dependencies += VertexFituninstall))

VertexFituninstall : $(VertexFituninstall_dependencies) ##$(cmt_local_VertexFit_makefile)
	$(echo) "(constituents.make) Starting uninstall VertexFit"
	@if test -f $(cmt_local_VertexFit_makefile); then \
	  $(MAKE) -f $(cmt_local_VertexFit_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_VertexFit_makefile) uninstall
	$(echo) "(constituents.make) uninstall VertexFit done"

remove_library_links :: VertexFituninstall
...
#cmt_local_tagfile_make = $(VertexFit_tag)_make.make
cmt_local_tagfile_make = $(bin)$(VertexFit_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)VertexFit_makesetup.make
...
#cmt_local_tagfile_make = $(VertexFit_tag).make
cmt_local_tagfile_make = $(bin)$(VertexFit_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)VertexFitsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(VertexFit_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(VertexFit_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)VertexFit_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(VertexFit_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(VertexFit_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)VertexFitsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(VertexFit_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(VertexFit_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)VertexFit_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(VertexFit_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(VertexFit_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)VertexFitsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(VertexFit_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(VertexFit_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)VertexFit_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(VertexFit_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(VertexFit_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)VertexFitsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(VertexFit_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(VertexFit_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)VertexFit_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(VertexFit_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(VertexFit_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)VertexFitsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(VertexFit_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(VertexFit_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)VertexFit_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(VertexFit_tag).make
cmt_local_tagfile_TestProject = $(bin)$(VertexFit_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)VertexFitsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(VertexFit_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(VertexFit_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)VertexFit_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(VertexFit_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(VertexFit_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)VertexFitsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(VertexFit_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(VertexFit_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)VertexFit_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(VertexFit_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(VertexFit_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)VertexFitsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
